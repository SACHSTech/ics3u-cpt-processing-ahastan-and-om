...
/**
* A program named "Bettors Haven", which allows users to click through any NBA team, view the stats of each
* player, and be provided with advice for which players to bet on and if the team has potential
* @author: S. Ahastan, B. Om
*
*/
...
public class Sketch extends PApplet {
  ...
  /**
  * Settings void called once in the program, initalizes the size of the display
  *
  * @author S. Ahastan, B. Om
  */
  ...
  /**
  * Setup void called once in the program, initalizes the background and text fonts
  *
  * @author S. Ahastan, B. Om
  */
  public void setup() {
  ...
  /**
  * Draw method called multiple times during the program, main source for directory for the screens.
  *
  * @author S. Ahastan, B. Om
  */
  public void draw() {
    ...
    if (screen1Move == true)
    {
      // Displays the stats for each player based on team chosen
      rosterScreen();
      if (playerMove1 == true)
      {
        background(92, 150, 242);
  ...
  /**
  * Mouse Clicked event called whenever the mouse is clicked. Directed by conditional structures and loops
  * to ensure correct action is being taken
  *
  * @author S. Ahastan, B. Om
  */
  public void mouseClicked()
  {
    //Introduction Page Commands and declaring the player's team
    ...
    // Button Commands on the roster screen
  ...
  /**
  * The initial introduction screen that the user sees in order to click a team.
  *
  * @author S. Ahastan, B. Om
  */
  //Introduction Screen
  ...
  /**
  * Roster Screen is the screen the user is directed to when they click on a certain team they wish to view
  *
  * @author S. Ahastan, B. Om
  */
  public void rosterScreen()
  {
    // Initalizing background and "back" button
    background(92, 150, 242);
    stroke(255);
    noFill();
    rect (360, 430, 100, 40);
